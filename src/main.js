...
(() => {
  ...
  const LEVELS = [
    ...
    { id:"rigdock", name:"4 · Loading dock ↩",
      goal:"The whole rig this time: back down the walled slot and stop with EVERYTHING — car included — inside the painted dock. That means finishing dead straight; a kinked park doesn't count.",
      start:{x:0,y:-330,th:-Math.PI/2},
      bay:{x:0,y:160,ang:Math.PI/2,fit:"rig"},
      obstacles:[ {t:"half",axis:"y",at:272,sign:1},
                  W(-50,150,Math.PI/2,120,6), W(50,150,Math.PI/2,120,6),
                  {t:"cone",x:-46,y:12},{t:"cone",x:46,y:12} ] },

    { id:"sweep", name:"5 · Short sweep ↩",
    ...
    { id:"roundabout", name:"6 · Roundabout ↩",
    ...
    { id:"sweepLong", name:"7 · Long sweep ↩",
    ...
    { id:"dogleg", name:"8 · Dogleg dock ↩",
      goal:"The bay hides behind a divider island, so there's no straight line to it. Back around either end of the island, then S the trailer in square — your first time swapping the kink from one side to the other mid-manoeuvre.",
      start:{x:0,y:-430,th:-Math.PI/2},
      bay:{x:170,y:160,ang:Math.PI/2,fit:"trailer"},
      obstacles:[ {t:"half",axis:"y",at:222,sign:1},
                  W(75,-60,0,95,12),
                  {t:"cone",x:136,y:118},{t:"cone",x:204,y:118} ] },
    ...
    { id:"corner", name:"11 · Around the corner ↩",
      goal:"A walled corridor with a 90° corner in it. Back the trailer down the lane, swing it around the bend without clipping the inside wall, then straighten out into the dock at the far end.",
      start:{x:0,y:430,th:Math.PI/2},
      bay:{x:500,y:-155,ang:0,fit:"trailer"},
      obstacles:[ {t:"half",axis:"x",at:560,sign:1},
                  W(-85,170,Math.PI/2,410,7), W(85,255,Math.PI/2,325,7),
                  W(237.5,-240,0,322.5,7), W(322.5,-70,0,237.5,7),
                  {t:"cone",x:445,y:-195},{t:"cone",x:445,y:-115} ] },

    { id:"slalom", name:"12 · Reverse slalom ↩",
